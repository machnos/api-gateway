...
/**
 * Test class for the <code>AtLeastOneFunctionMustSucceed</code> class.
 */
public class AtLeastOneFunctionMustSucceedTest extends AbstractCompoundFunctionTest<AtLeastOneFunctionMustSucceed> {

    @Override
    protected AtLeastOneFunctionMustSucceed getInstance() {
        return new AtLeastOneFunctionMustSucceed();
    }
     ...
     */
    @Test
    public void testOneFunctionSucceeds() {
        var function = getInstance()
